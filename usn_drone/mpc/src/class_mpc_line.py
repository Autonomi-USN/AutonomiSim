...
class mpc:
    ...
    def optimize(self, x_init, y_init, yaw_init, u_init, v_init, r_init, x_target, y_target, x_target_prev, y_target_prev):
        ...
        for k in range(0,N+1): #new - set the reference to track
            ...
            #! to stop if overshoot (troubleshooting)
        ...
        print(x_init, y_init, yaw_init, self.u, self.v, r_init)
    ...
    def run(self):
        ...
        for x, y in zip(self.target_list_x, self.target_list_y):
            ...
            while True:
                ...
                # print('prev:', x_target_prev, y_target_prev)
                # print('current:', x_target, y_target)
                ...
                print('thrust:', cont_XP1, cont_XP2)
