...
class Node():
    def __init__(self):
        ...
        self.left_publisher = rospy.Publisher('/usn_drone/thrusters/left_thrust_cmd', Float32, queue_size=10)
        self.right_publisher= rospy.Publisher('/usn_drone/thrusters/right_thrust_cmd', Float32, queue_size=10)
    ...
    def odom_callback(self,msg):
        ...
        self.left_thrust_msg.data = -1*torque + thrust
        self.right_thrust_msg.data =torque + thrust
        
        self.left_publisher.publish(self.left_thrust_msg)
        self.right_publisher.publish(self.right_thrust_msg)
...
if __name__ == '__main__':
    ...
    # Setup subscribers
    s1 = rospy.Subscriber('/usn_drone/robot_localization/odometry/filtered',Odometry,node.odom_callback)
