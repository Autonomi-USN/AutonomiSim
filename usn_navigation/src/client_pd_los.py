...
buoy0_pos = get_position('redbuoy0')
buoy1_pos = get_position('redbuoy1')
boat_pos = get_position('usn_drone/base_link')

a, b, [x_0, y_0] = equation_of_normal(buoy0_pos, buoy1_pos)
target_1, target_2 = (get_waypoints(x_0, a, b, 3))

targets_ordered = order_points_by_distance([boat_pos[0], boat_pos[1]], target_1, target_2)

goal.poses.poses.append(generate_pose_msg(boat_pos))
goal.poses.poses.append(generate_pose_msg(targets_ordered[0]))
goal.poses.poses.append(generate_pose_msg(targets_ordered[1]))
